...
# )
send_mail = SendEmail(
    username='fengjie_w1@163.com',
    passwd='ARQOCZSVPBVZKYAY',
    recv=['2808369777@qq.com'],
    title='接口自动化报告',
    content='测试发送邮件',
    # file=r'D:\images2\bizhi.jpg',
    file=r'D:\myCode\Interface-automation-framework\result\report.html',
...
class AllTest:  # 定义一个类AllTest
    def __init__(self):  # 初始化一些参数和数据
        ...
        # print(self.caseListFile,"caseListFile")
    ...
    def set_case_suite(self):
        ...
        for case in self.caseList:  # 从caselist元素组中循环取出case
            ...
            # print(case_name + ".py","打印出取出来的名称")  # 打印出取出来的名称
